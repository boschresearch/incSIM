...
#ifndef SRC_INC_NETWORK_INFO_GENERATION_HPP_
#define SRC_INC_NETWORK_INFO_GENERATION_HPP_
...
namespace ns3 {
    namespace ndn {
        ...
        class DataGen
        {
          ...
          void
          generate_data(uint32_t num_consumer_nodes, uint32_t num_compute_nodes, uint32_t num_func, std::pair<int,int> input_range, std::pair<int, int>frequency_range, uint32_t sim_time, bool zipf, bool nfn_load_distribution_scenario);
          void
          generate_func_list(uint32_t num_func, std::pair<int, int> input_range);
          std::string
          generate_input_list(int num_inputs, uint32_t num_consumer_nodes);
          //void
          //generate_freq_list(uint32_t num_func, std::pair<int, int>frequency_range);
          void
          generate_provided_data(uint32_t num_consumer_nodes);
