...
#ifndef SRC_INC_ORCHESTRATOR_COMMUNICATION_TRACER_HPP_
#define SRC_INC_ORCHESTRATOR_COMMUNICATION_TRACER_HPP_
...
/// @cond include_hidden
struct RequestStats_orchestrator {
  inline void
  Reset()
  {
 ...
 */
class IncOrchestratorCommunicationTracer : public SimpleRefCount<IncOrchestratorCommunicationTracer> {
public:
  /**
   ...
   * tuple needs to be preserved for the lifetime of simulation, otherwise SEGFAULTs are inevitable
   */
  static Ptr<IncOrchestratorCommunicationTracer>
   ...
   */
  IncOrchestratorCommunicationTracer(std::shared_ptr<std::ostream> os, Ptr<Node> node);
   ...
   */
  IncOrchestratorCommunicationTracer(std::shared_ptr<std::ostream> os, const std::string& node);

  /**
   * @brief Destructor
   */
  ~IncOrchestratorCommunicationTracer();
...
private:
  ...
  void
  SendOrchestrationInterests(shared_ptr<const Interest>);

  void
  IncomingOrchestrationDatas(shared_ptr<const Data>);

  void
  SendOrchestrationDecisions(shared_ptr<const Interest>);
...
private:
  ...
  RequestStats_orchestrator m_stats;
};
 ...
 */
inline std::ostream&
operator<<(std::ostream& os, const IncOrchestratorCommunicationTracer& tracer)
{
  os << "# ";
